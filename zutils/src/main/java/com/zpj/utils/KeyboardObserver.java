...
public final class KeyboardObserver {
     ...
     */
    public static void registerSoftInputChangedListener(final Activity activity, final View popupView, final OnSoftInputChangedListener listener) {
    ...
    public static void removeLayoutChangeListener(View decorView, View popupView){
